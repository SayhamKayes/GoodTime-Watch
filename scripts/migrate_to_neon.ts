  ...
  try {
    ...
    await sql`
      INSERT INTO site_settings (
        ...
        ${SITE_INFO.productInquiryPhone || SITE_INFO.phoneDisplay},
        ${SITE_INFO.productInquiryWhatsapp || SITE_INFO.whatsappNumber},
        ${SITE_INFO.productInquiryDisplay || SITE_INFO.phoneDisplay},
        ${SITE_INFO.prebookPhone || SITE_INFO.phoneDisplay},
        ${SITE_INFO.prebookWhatsapp || SITE_INFO.whatsappNumber},
        ${SITE_INFO.prebookDisplay || SITE_INFO.phoneDisplay},
